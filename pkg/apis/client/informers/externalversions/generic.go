...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("replacedisks"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Hwameistor().V1alpha1().ReplaceDisks().Informer()}, nil
